...
export default function PetProfile(props) {
  ...
  const buttonThreeOneFiveSevenTwoSixEightThreeOnClick =
  ...
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeOneFiveSevenTwoSixEightThreeOnClick();
        }}
        {...getOverrideProps(overrides, "Button31572683")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      >
        <Button
          ...
          variation="primary"
          children="Update"
          {...getOverrideProps(overrides, "Button31562680")}
        ></Button>
        <Button
          display="flex"
          gap="0"
